...
import ExerciseSelection, { ExerciseRecord } from "./ExerciseSelection";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
        ...
        exercise.sets
          ...
          .reduce((setAcc, curr) => {
            if (
              ...
              return setAcc + parseInt(curr.weight) * parseInt(curr.reps);
            } else {
              return setAcc;
            }
          }, 0)
  ...
  const handleAddExercisesToLog = (selectedExercises: ExerciseRecord[]) => {
    const newExercises = [
      ...
      ...selectedExercises.map((exercise) => ({
        ...
        id: exercise.id,
        sets: [{ weight: "", reps: "", completed: false, selected: false }],
      })),
    ];
    setExercises(newExercises);
        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Please add a title for your workout. Click save when you're
                done.
              </DialogDescription>
            </DialogHeader>
          ...
          {exercises &&
            ...
            exercises.map((exercise, index) => (
              <ExerciseCard
                ...
                sets={exercise.sets}
                onSetsChange={(newSets) => handleExerciseChange(index, newSets)}
          ...
          <div className="m-2 mt-2">
            ...
            {showExerciseSelectionModal && (
              <ExerciseSelection
                ...
                onCancel={() => setShowExerciseSelectionModal(false)}
              />
            )}
          </div>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    If you discard this workout, all unsaved changes will be
                    lost.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Go Back</AlertDialogCancel>
                  <AlertDialogAction>Discard Workout</AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
          </div>
